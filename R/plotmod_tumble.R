#' @title Tumble Graphs for Plotting Moderation Effect
#'
#' @description Plot the moderation effect in a regression model using tumble
#'               graph.
#'
...
#'          report this in the plot if required. Similar to [plotmod()] but
#'          a tumble graph proposed by Bodner (2016) is used.
#'
...
plotmod_tumble <- function(output, x, w,
                            x_label,
                            w_label,
                            y_label,
                            title,
