...
test_that("Check models", {
  expect_error(std_selected_lavaan(HolzingerSwineford1939))
  expect_error(std_selected_lavaan(fit_mlm))
  expect_error(std_selected_lavaan(fit_nodata))
  expect_error(std_selected_lavaan(fit_condx))
})
