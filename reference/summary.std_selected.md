...
An object of class `summary.std_selected`, with bootstrap confidence
intervals added if present in the object. The object is a list. Its main
element `coefficients` is similar to the coefficient table in the
[`summary()`](https://rdrr.io/r/base/summary.html) printout of
[`lm()`](https://rdrr.io/r/stats/lm.html). This object is for printing
summary information of the results from
[`std_selected()`](https://sfcheung.github.io/stdmod/reference/std_selected.md)
or
[`std_selected_boot()`](https://sfcheung.github.io/stdmod/reference/std_selected.md).
