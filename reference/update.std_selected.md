...
This should be used only to update the call to
[`lm()`](https://rdrr.io/r/stats/lm.html), not to the call to
...
If `evaluate` = `TRUE`, it returns the updated fitted object, otherwise,
the updated call.
...
or
[`std_selected_boot()`](https://sfcheung.github.io/stdmod/reference/std_selected.md).
It is recommended to call [`lm()`](https://rdrr.io/r/stats/lm.html)
