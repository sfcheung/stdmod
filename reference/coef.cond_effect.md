...
Return the estimates of the conditional effects in the output of
...
A numeric vector: The estimates of the conditional effects in a
`cond_effect`-class object.

## Details

It just extracts and returns the column of conditional effects in a
`cond_effect`-class object.
