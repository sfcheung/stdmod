...
the function can be slow if nonparametric bootstrapping confidence interval
...
If nonparametric bootstrapping confidence interval is requested,
...
processed by `stdmod_selected()`:

```{r echo = FALSE}
if (file.exists("egl_lm_xwy_std_ci")) {
