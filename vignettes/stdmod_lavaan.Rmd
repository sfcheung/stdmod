...
The output is a list of the class `stdmod_lavaan`.
The standardized moderation effect can be retrieved by `coef()`:
...
Nonparametric bootstrap confidence interval can be retrieved
by `confint()`:
...
The level of confidence can be changed using the argument `level`:
