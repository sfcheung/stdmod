---
title: "Plot Moderation Effects by plotmod()"
author: "Shu Fai Cheung"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Plot Moderation Effects by plotmod()}
...
It can show a moderation effect by plotting the effect of
the predictor on the outcome for different levels of
the moderator:
...
of each line depends on the distribution of the predictor in each level 
of the moderator:
...
Statistics, 41*(6), 593-604. https:/doi.org/10.3102/1076998616657080
