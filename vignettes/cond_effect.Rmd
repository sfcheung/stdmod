...
It has more comprehensive support than `stdmod`. See [these articles](https://sfcheung.github.io/manymome/articles/#moderated-regression)
...
> However, if only mean-centering is needed, `stdmod` should
be used because `betaselectr` does not support doing only
mean-centering.
