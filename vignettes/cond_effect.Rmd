...
Note that the empirical percentage of cases less than or below a level may
...
appropriate (Cheung, Cheung, Lau, Hui, & Vong, 2022). Users can
...
mean to define "Low" and "High", or the percentiles to be used.
